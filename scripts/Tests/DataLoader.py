...
class DataLoader():
    ...
    def next_batch(self):
        ...
        while i < self.batch_size:
            ...
            if idx + self.seq_length-1 < len(frame_data):
                ...
                target_ids.append(self.target_ids[self.dataset_pointer][math.floor(
    ...
    def get_directory_name(self, offset=0):
        ...
        folder_name = self.data_dirs[self.dataset_pointer +
                                     offset].split('/')[-2]
        return folder_name
    ...
    def get_starting_time(self, pedlist, ped_poses):
        ped_nums = unique(pedlist)
        starting_episode = {}
        for i in ped_nums:
    ...
    def get_starting_pose(self, pedlist, ped_poses):
        ped_nums = unique(pedlist)
        starting_pose = {}
        for i in ped_nums:
    ...
    def get_ped_goals(self, pedlist, ped_poses):
        final_goals = {}
