...
from optimization import  get_poses_probability, Linear, optimize, lr
...
if __name__ == '__main__':
    ...
    for i in range (1000):
        ...
        for policy in policies:
            ...
            starting_poses, goals, param.robot_speed = apply_policy(policy, starting_poses, goals, param.robot_speed)
        ...
        with torch.no_grad():
            param.input_state, goals, param.robot_speed = apply_policy(policy, param.input_state, goals, param.robot_speed)
        
        
        with torch.no_grad():
            # propagate
            rf, af = calc_forces(param.input_state, param.goal, param.pedestrians_speed, param.robot_speed, param.k, param.alpha, param.ped_radius, param.ped_mass, param.betta)
            F = rf + af
