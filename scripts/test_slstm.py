...
class Mpdm_Datagen(Datagen):
    def __init__(self,num_peds, pred_length=8, obs_length=8, ):
    ...
    def fake_data_gen(self):
        ...
        #   self.pred_lengt + self.obs_length , each of them:
        #       self.numpeds, each of them:
        #           id, x ,y
